...
/** @type {string} */
const CACHE_VERSION = '1789776869|4164528';
/** @type {string} */
const CACHE_PREFIX = 'Carlito-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'c2-6556a611.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["c2-6556a611.html","c2-6556a611.js","c2-6556a611.offline.html","c2-6556a611.icon.png","c2-6556a611.apple-touch-icon.png","c2-6556a611.audio.worklet.js","c2-6556a611.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["c2-6556a611.wasm","c2-6556a611.pck"];
